...
INSERT INTO Promotions (idPromotion, nomPromotion, nbEtudiantsPromotion) (SELECT * FROM Palleja.PERI2_Promotions);
INSERT INTO Groupes (idGroupe, idPromotion) (SELECT * FROM Palleja.PERI2_Groupes);
INSERT INTO Etudiants (idEtudiant, nomEtudiant, prenomEtudiant, sexeEtudiant, dateNaissanceEtudiant, idGroupe) (SELECT * FROM Palleja.PERI2_Etudiants);
INSERT INTO Semestres (idSemestre, dateDebutSemestre, dateFinSemestre, idPromotion) (SELECT * FROM Palleja.PERI2_Semestres);
INSERT INTO Modules (idModule, nomModule, idSemestre, coefficientModule) (SELECT * FROM Palleja.PERI2_Modules);
INSERT INTO Matieres (idMatiere, nomMatiere, idModule, coefficientMatiere) (SELECT * FROM Palleja.PERI2_Matieres);
INSERT INTO Notes (idEtudiant, idMatiere, note) (SELECT * FROM Palleja.PERI2_Notes);
